...
author: 'Your R. Name'
IDnumber: '1234567'
course: 'Scienze Statistiche e Decisionali'
courseorganizer: 'Dipartimento di Scienze Statistiche'
date: 'July 20xx'
copyyear: '2020'
advisor: 'Advisor F. Name'
authoremail: 'your\@mail.com'
degree: 'Lau'
options: 'draft, english'
knit: "bookdown::render_book"
site: bookdown::bookdown_site
output: 
  sapthesisdown::thesis_pdf: default
#  sapthesisdown::thesis_gitbook: default
#  sapthesisdown::thesis_word: default
#  sapthesisdown::thesis_epub: default
...
lot: true
lof: true
# If you prefer blank lines between paragraphs, un-silence the following lines (this requires package tikz to be installed)
#header-includes:
#- \usepackage{tikz}
---
...
# This chunk ensures that the sapthesisdown package is
# installed and loaded. This sapthesisdown package includes
# the template files for the thesis.
if(!require(devtools))
  install.packages("devtools", repos = "http://cran.rstudio.com")
if(!require(sapthesisdown))
  devtools::install_github("tulliapadellini/sapthesisdown")
library(sapthesisdown)
```
...
Welcome to the _R Markdown_ thesis template. This package is based on (and in many places, like here, copied directly from) the thesidown package. Its aim is to provide a nicer interface for those that have never used TeX or LaTeX before.  Using _R Markdown_ will also allow you to easily keep track of your analyses in **R** chunks of code, with the resulting plots and output included as well. The hope is this _R Markdown_ template gets you in the habit of doing reproducible research, which benefits you long-term as a researcher, but also will greatly help anyone that is trying to reproduce or build onto your results down the road.
